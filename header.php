    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-8 breaking-wraper hidden-xs">
                ...
                <h3 class="breaking-title"><?php _e('Breaking News','newszine')?></h3>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9">              
                    ...
                    <?php if ( is_active_sidebar( 'header_advertisment' ) ) : ?>                      
                        <?php dynamic_sidebar( 'header_advertisment' ); ?>                       
                    <?php endif; ?>             
                        ...
                        <div class="search hidden-xs">
                            ...
                            <div class="search-form">
                                <form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get" accept-charset="utf-8">
                                    <input type="search" class="form-control" name="s" value="<?php echo get_search_query(); ?>" placeholder="<?php _e('Enter a keyword','newszine');?>">
                                </form>
                            </div>
                        </div>
                    </div>
